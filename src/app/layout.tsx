...
export const metadata: Metadata = {
  ...
  description: "Traditional bakery serving fresh artisan breads, French pastries, and custom cakes daily. Family-owned since 1952 with premium ingredients and time-honored techniques.",
  keywords: "bakery, fresh bread, artisan pastries, custom cakes, sourdough, croissants, family bakery",
  metadataBase: undefined,
  alternates: undefined,
  openGraph: {
    title: "Sweet Delights Bakery - Fresh Baked Daily",
    description: "Experience 72 years of baking excellence with fresh artisan breads, French pastries, and custom cakes made with premium ingredients.",
  ...
  twitter: {
    ...
    description: "Traditional family bakery serving fresh daily selections since 1952"
  },
  robots: {
    index: true,
    follow: true
